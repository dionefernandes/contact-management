	...
	<header>
		...
		<form method="post" action="{{route('user.update', $user->id)}}">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control @error('contato') is-invalid @enderror" id="contato" name="contato" maxlength="9" value="{{$user->contato}}">
				@error('contato')
					<div class="invalid-feedback">
						{{$message}}
					</div>
			...
			<div class="mb-3">
				...
				<input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" aria-describedby="email" value="{{$user->email}}">
				@error('email')
					<div class="invalid-feedback">
						{{$message}}
					</div>
